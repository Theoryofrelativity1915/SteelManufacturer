...
import img2 from '../assets/umit-yildirim-9OB46apMbC4-unsplash-small.jpg'
import img3 from '../assets/jeriden-villegas-VLPUm5wP5Z0-unsplash-small.jpg'
import img4 from '../assets/samuel-regan-asante-g9A2llpDObU-unsplash-small.jpg'
import 'swiper/css';
...
const ImageCarousel = () => {
  return (
    <Swiper
      ...
      <SwiperSlide className='flex max-h-[40vh] justify-center items-center'>
        {({ isActive }) => (<>
          <img src={img3} loading="eager" className='brightness-75 object-cover object-center w-full h-auto max-h-[40vh]' />
          <div className={isActive ? 'opacity-100 absolute text-white p-10 border border-white text-xl md:text-8xl delay-500 duration-700' : 'delay-500 duration-700 opacity-0 absolute text-white p-10 border border-white text-xl md:text-8xl'}>
      ...
      <SwiperSlide className='flex max-h-[40vh] justify-center items-center'>
        {({ isActive }) => (<>
          <img src={img4} loading='eager' className='brightness-75 object-cover object-center w-full h-auto max-h-[40vh]' />
          <div className={isActive ? 'opacity-100 absolute text-white p-10 border border-white text-xl md:text-8xl delay-500 duration-700' : 'delay-500 duration-700 opacity-0 absolute text-white p-10 border border-white text-xl md:text-8xl'}>
